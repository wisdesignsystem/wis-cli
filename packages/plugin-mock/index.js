...
export default function (plugin) {
  ...
  plugin.hooks.webpackDevServerConfigure.tap((webpackDevServerConfigure) => {
    const oldSetupMiddlewares = webpackDevServerConfigure
      .get("setupMiddlewares")
      ?.toValue();
    webpackDevServerConfigure.set(
      "setupMiddlewares",
      (middlewares, devServer) => {
        createMock(devServer);
        const nextMiddlewares = oldSetupMiddlewares
          ? oldSetupMiddlewares(middlewares, devServer)
          : middlewares;
